...
export let multilocation = [
  {
    ...
    cities: [
      {
        city: "Pekin",
        multilocation: ["Kroger", "Towne Oaks", "Groveland", "Groveland Chapels"],
      },
      {
        city: "Shanxay",
        multilocation: ["Deer Creek", "View details", "Mayfair", "Goodfield", "Carlock", "Congerville"],
      },
      {
        city: "Lanzhou",
  ...
  },
  {
    ...
    cities: [
      {
        city: "Tashkent",
        multilocation: ["Sergeli", "Marsim Gorkiy", "Yunisobod", "Mirzo Ulugbek", "Chilonzor"],
      },
      {
        city: "Fergana",
      ...
      {
        city: "Qashqadaryo",
        multilocation: ["Qarshi", "Chirakchi", "Shaxrisabz", "Kitob", "Yakkabog"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      {
        city: "New York",
        multilocation: ["Brockleen Bringe", "Coma", "Arezona", "Mottemham", "Carlson Street", "Congerville", "Phoenix"],
      },
      {
        city: "Los Angeles",
      ...
      {
        city: "San Francisco",
        multilocation: ["San Jose", "San Diego", "Phoenix", "Colarado", "Panola"],
      },
      {
        city: "Cansas",
  ...
  },
  {
    ...
    cities: [
      {
        city: "Moscow",
        multilocation: ["Odintsovo", "Lesnoy Gorodok", "Borodki", "Pykhtino", "Lyubertsy", "Khimki", "Zelenograd"],
      },
    ],
  },
];
export let time = ["08:00", "10:00", "12:00", "14:00", "16:00", "18:00", "20:00", "22:00"];
